...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        checkButton.setOnClickListener {
            ...
            Toast.makeText(this, "Checkbox yang dipilih $resultText", Toast.LENGTH_SHORT).show()
        }
        ...
        radioButtonsButton.setOnClickListener {
            ...
            Toast.makeText(this, "Radio button yang Dipilih: $selectedText", Toast.LENGTH_SHORT).show()
        }

        // Spinner
        val spinner = findViewById<Spinner>(R.id.spinner)
        val spinnerButton = findViewById<Button>(R.id.spinnerButton)
        val spinnerValues = arrayOf("Buku", "Pensil", "Penghapus", "Makanan","Minuman","Bola")
        val spinnerAdapter = ArrayAdapter(this, android.R.layout.simple_spinner_dropdown_item, spinnerValues)
        spinner.adapter = spinnerAdapter
        spinnerButton.setOnClickListener {
            val selectedValue = spinner.selectedItem.toString()
            Toast.makeText(this, "Opsi yang dipilih: $selectedValue", Toast.LENGTH_SHORT).show()
        }
    }
}